...
RUN ln -s /usr/lib/x86_64-linux-gnu/libnvidia-encode.so.1 /home/ue4/project/KRPixel/Binaries/Linux/libnvidia-encode.so.1

# Set the packaged project as the container's entrypoint
# ENTRYPOINT ["/home/ue4/project/DummyProject.sh", "-AudioMixer", "-opengl4"] 
